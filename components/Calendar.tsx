  ...
  return (
    <div className="relative" ref={ref}>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="w-full px-4 py-3 border-2 border-ink/15 rounded-xl text-sm text-left bg-white flex items-center justify-between focus:outline-none focus:border-sky-blue-light"
      >
